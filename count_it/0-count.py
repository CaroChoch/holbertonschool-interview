...
def count_words(subreddit, word_list):
    ...
    # Define URL for the Reddit API endpoint, formatted with the subreddit name
    ...
    for word in word_list:
        ...
        for title in hot_titles:
            word_count[word] += len(
                re.findall(r'\b{}\b'.format(word), title, re.IGNORECASE))

    # Sort the word list by count (descending) and alphabetically (ascending)
    # in case of a tie
